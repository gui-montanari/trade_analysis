...
def setup_application(app: QApplication) -> QApplication:
    ...
    for font_file in ['Roboto-Regular.ttf', 'Consolas.ttf']:
        try:
            font_path_full = font_path / font_file
            if font_path_full.exists():
                font_db.addApplicationFont(str(font_path_full))
        except Exception as e:
